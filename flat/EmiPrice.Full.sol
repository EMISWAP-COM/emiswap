...
contract EmiPrice is Initializable, Priviledgeable {
 ...
 string public codeVersion = "EmiPrice v1.0-137-gf94b488";
    ...
    function _getOurPrice(address[] memory _coins, uint256[] memory _prices)
        internal
        view
    {
    ...
    function _get1inchPrice(address[] memory _coins, uint256[] memory _prices)
        internal
        view
    {
